...
// import { Edit, Trash2, Plus, Wrench, Calendar, MapPin, User } from 'lucide-react';
...
//     loading,
//     fetchJobCardsOther,
//     deleteJobCardOther } = useJobCardsOther();
...
//               Other Services Job Cards
//             </h2>
//             <p className="text-sm text-gray-600">
//               {jobCards.length} {jobCards.length === 1 ? 'card' : 'cards'} total
//             </p>
//           </div>
//         </div>
//         <Button
//           onClick={onOpenForm}
//           className="flex items-center bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-lg"
//         >
...
//               className="cursor-pointer bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover:border-blue-300 group"
//             >
//               {/* Header */}
...
import { useJobCardsOther, type JobCardOther } from '../../context/JobCardOtherContext';
import { Button } from '../ui/button';
import { Edit, Trash2, Plus, Wrench, Calendar, MapPin } from 'lucide-react';
import JobCardOtherDetails from './JobCardOtherDetails';
import { Dialog } from '../ui/dialog';
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 px-4 sm:px-0">
        <div className="flex items-center space-x-3 mb-2 sm:mb-0">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              {jobCardsOther.length} {jobCardsOther.length === 1 ? 'card' : 'cards'} total
            </p>
          </div>
        </div>
        <Button
