...
{showReferenceInput && (<div className="mt-4 relative">
...
<Input
 ...
 required
 placeholder="Reference name" className="w-full rounded-md shadow-sm border-gray-300 focus:border-emerald-500 focus:ring-emerald-200 pl-10"
 />
</div>
 )}
 </div>
