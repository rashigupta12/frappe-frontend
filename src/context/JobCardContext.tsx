...
//   const transformJobCardData = (apiData: any): JobCard => {
//     console.log("🔧 Transforming API data:", apiData);
   
//     return {
//       name: safeGet(apiData, 'name', ''),
//       owner: safeGet(apiData, 'owner', ''),
//       creation: safeGet(apiData, 'creation', ''),
//       modified: safeGet(apiData, 'modified', ''),
//       modified_by: safeGet(apiData, 'modified_by', ''),
//       docstatus: safeGet(apiData, 'docstatus', 0),
//       idx: safeGet(apiData, 'idx', 0),
//       doctype: safeGet(apiData, 'doctype', ''),
//       date: safeGet(apiData, 'date', ''),
     
//       // Try multiple possible field names for each property
//       party_name: safeGet(apiData, 'party_name') ||
//                   safeGet(apiData, 'custom_customer_name') ||
//                   safeGet(apiData, 'customer_name') ||
//                   safeGet(apiData, 'customer') || '',
                 
//       property_no: safeGet(apiData, 'property_no') ||
//                    safeGet(apiData, 'custom_property_no') || '',
                   
//       building_name: safeGet(apiData, 'building_name') ||
//                      safeGet(apiData, 'custom_building_name') || '',
                     
//       area: safeGet(apiData, 'area') ||
//             safeGet(apiData, 'custom_area') || '',
           
//       start_date: safeGet(apiData, 'start_date') ||
//                   safeGet(apiData, 'custom_start_date') || '',
                 
//       finish_date: safeGet(apiData, 'finish_date') ||
//                    safeGet(apiData, 'custom_finish_date') || '',
                   
//       prepared_by: safeGet(apiData, 'prepared_by') ||
//                    safeGet(apiData, 'custom_prepared_by') || '',
                   
//       approved_by: safeGet(apiData, 'approved_by') ||
//                    safeGet(apiData, 'custom_approved_by') || '',
                   
//       project_id_no: safeGet(apiData, 'project_id_no') ||
//                      safeGet(apiData, 'custom_project_id_no_') ||
//                      safeGet(apiData, 'custom_project_id_no') || '',
                     
//       ac_v_no_and_date: safeGet(apiData, 'ac_v_no_and_date') ||
//                         safeGet(apiData, 'custom_ac_v_no__date') ||
//                         safeGet(apiData, 'custom_ac_v_no_and_date') || '',
                       
//       pressing_charges: Array.isArray(apiData.pressing_charges) ? apiData.pressing_charges :
//                        Array.isArray(apiData.custom_pressing_charges) ? apiData.custom_pressing_charges : [],
                       
//       material_sold: Array.isArray(apiData.material_sold) ? apiData.material_sold :
//                     Array.isArray(apiData.custom_materials_sold) ? apiData.custom_materials_sold :
//                     Array.isArray(apiData.custom_material_sold) ? apiData.custom_material_sold : [],
//     };
//   };
...
//           console.log("🔍 First job card raw data:", response.data[0]);
//           console.log("🔑 Available fields:", Object.keys(response.data[0]));
//         }
       
//         // Transform each job card
//         const transformedJobCards = response.data.map(transformJobCardData);
//         console.log("✅ Transformed job cards:", transformedJobCards);
       
//         setJobCards(transformedJobCards);
//       } else {
//         console.log("📭 No job cards data found");
//         setJobCards([]);
//       }
//     } catch (err) {
...
export const JobCardProvider: React.FC<JobCardProviderProps> = ({ children }) => {
  ...
  // Transform API data to match our interface - Updated for your exact JSON structure
  // const transformJobCardData = (apiData: any): JobCard => {
  //   console.log("🔧 Transforming API data:", apiData);
  ...
  //     // Direct field mapping - your JSON structure matches perfectly
  //     date: safeGet(apiData, 'date', ''),
  //     party_name: safeGet(apiData, 'party_name', ''),
  //     property_no: safeGet(apiData, 'property_no', ''),
  //     building_name: safeGet(apiData, 'building_name', ''),
...
//   // The actual data is in the 'data' property based on your API response
